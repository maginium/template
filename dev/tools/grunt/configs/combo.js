...
module.exports = {
  ...
  autopath: function (themeName, folder) {
    return folder + theme[themeName].area + "/" + theme[themeName].name + "/" + theme[themeName].locale + "/";
  },
  ...
  lessFiles: function (themeName) {
    ...
    for (i; i < theme[themeName].files.length; i++) {
      cssStringArray[i] =
        path.pub + theme[themeName].area + "/" + theme[themeName].name + "/" + theme[themeName].locale + "/" + theme[themeName].files[i] + ".css";

      lessStringArray[i] =
        path.pub + theme[themeName].area + "/" + theme[themeName].name + "/" + theme[themeName].locale + "/" + theme[themeName].files[i] + ".less";
