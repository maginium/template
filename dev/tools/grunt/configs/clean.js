    ...
    files: [
      {
        force: true,
        dot: true,
        src: ["<%= path.pub %>frontend/**/*", "<%= path.pub %>adminhtml/**/*", "<%= path.deployedVersion %>"],
      },
    ],
  },
  styles: {
    ...
    files: [
      {
        force: true,
        dot: true,
        src: ["<%= path.tmp %>/cache/**/*", "<%= path.tmp %>/view_preprocessed/html/**/*", "<%= path.tmp %>/page_cache/**/*"],
      },
    ],
  },
  js: {
    ...
    files: [
      {
        force: true,
        dot: true,
        src: ["<%= path.pub %>**/*.js", "<%= path.pub %>**/*.html", "<%= path.pub %>_requirejs/**/*", "<%= path.deployedVersion %>"],
      },
    ],
  },
  generation: {
    ...
    files: [
      {
        force: true,
        dot: true,
        src: ["<%= path.generation %>code/**/*", "<%= path.generation %>metadata/**/*"],
      },
    ],
  },
};
