...
/*eslint max-depth: 0*/
define(["jquery", "jquery-ui-modules/widget", "jquery-ui-modules/datepicker", "jquery-ui-modules/timepicker"], function ($) {
  "use strict";
  ...
  $.widget("mage.calendar", {
    ...
    _overwriteGenerateHtml: function () {
      ...
      $.datepicker.constructor.prototype._generateHTML = function (inst) {
                ...
                tbody +=
                  ...
                  (otherMonth && !showOtherMonths
                    ...
                    : " " +
                      ...
                      (printDate.getDate() === today.getDate() && printDate.getMonth() === today.getMonth() && printDate.getYear() === today.getYear()
                        ? " ui-datepicker-today"
                        : "")) +
                  '"' +
        ...
        html +=
          buttonPanel + ($.ui.ie6 && !inst.inline ? '<iframe src="javascript:false;" class="ui-datepicker-cover" frameborder="0"></iframe>' : "");
    ...
    _initPicker: function (element) {
      var picker = element[this._picker()](this.options),
        pickerButtonText = picker.next(".ui-datepicker-trigger").find("img").attr("title");
    ...
    $.extend(
      ...
      /** @lends {$.mage.calendar.prototype} */ {
        ...
        _convertFormat: function (format, type) {
          var symbols = format.match(/([a-z]+)/gi),
            separators = format.match(/([^a-z]+)/gi),
            self = this,
            convertedFormat = "";

          if (symbols) {
            $.each(symbols, function (key, val) {
              convertedFormat += (self.dateTimeFormat[type][val] || val) + (separators[key] || "");
            });
          }
