...
define(["jquery", "matchMedia", "jquery-ui-modules/menu", "mage/translate"], function ($, mediaCheck) {
  "use strict";
  ...
  $.widget("mage.menu", $.ui.menu, {
    ...
    _toggleMobileMode: function () {
      ...
      $.each(
        ...
        $.proxy(function (index, item) {
          ...
          this.categoryLink = $("<a>").attr("href", categoryUrl).text($.mage.__("All %1").replace("%1", category));

          this.categoryParent = $("<li>").addClass("ui-menu-item all-category").html(this.categoryLink);
    ...
    expand: function (event) {
      ...
      if (newItem && newItem.length) {
        if (newItem.closest(".ui-menu").is(":visible") && newItem.closest(".ui-menu").has(".all-categories")) {
          return;
        }
  ...
  $.widget("mage.navigation", $.mage.menu, {
    ...
    setupMoreMenu: function () {
      ...
      this.moreListContainer = $("<li>").append(moreLink).append(this.moreItemsList);
