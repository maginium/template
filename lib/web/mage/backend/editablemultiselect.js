...
define([
  ...
  window.EditableMultiselect = function (settings) {
    ...
    EditableMultiselect.prototype.createEntity = function (value, options) {
      ...
      (select = $("#" + this.targetSelectId)), (entityIdName = this.entityIdName), (entityValueName = this.entityValueName), (entityInfo = {});
      ...
      ajaxOptions = {
        ...
        success: function (result) {
          ...
          if (result.success) {
            ...
            select.append('<option value="' + result[entityIdName] + '" selected="selected">' + resultEntityValueName + "</option>");
            ...
            inputSelector = "." + options.mselectInputContainerClass + " [type=text]." + options.mselectInputClass + "";
