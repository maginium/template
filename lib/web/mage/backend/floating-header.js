...
define(["jquery", "jquery/ui"], function ($) {
  ...
  $.widget("mage.floatingHeader", {
    ...
    _setVars: function () {
      ...
      this._height = this.element.parents(this.options.pageMainActions).outerHeight();
    },
    ...
    _handlePageScroll: function () {
      ...
      if (isActive) {
        this.element.addClass(this.options.fixedClass).parents(this.options.pageMainActions).addClass(this.options.hiddenClass);
      } else {
        this.element.removeClass(this.options.fixedClass).parents(this.options.pageMainActions).removeClass(this.options.hiddenClass);
      }
