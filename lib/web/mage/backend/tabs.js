...
/* global FORM_KEY */
define(["jquery", "jquery/ui", "jquery/ui-modules/widgets/tabs"], function ($) {
  "use strict";
  ...
  $.widget("mage.tabs", $.ui.tabs, {
    ...
    _getTabIndex: function (id) {
      var anchors = this.anchors ? this.anchors : this._getList().find("> li > a[href]");
  ...
  $.widget("mage.tabs", $.mage.tabs, {
    ...
    _refresh: function () {
      ...
      ($(this.options.destination).is("form") ? $(this.options.destination) : $(this.options.destination).closest("form"))
    ...
    _updateNavTitleMessages: function (e, messageType) {
      ...
      if (curItemMessages.is(":empty")) {
        curAnchor.find('[data-role="item-messages"]').clone().appendTo(curItemMessages);
      }
