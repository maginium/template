...
define(["jquery", "Magento_Ui/js/modal/modal", "mage/mage", "prototype"], function (jQuery) {
  ...
  AdminBackup.prototype = {
    ...
    toggleFtpCredentialsForm: function () {
      $("use_ftp").checked ? $("ftp-credentials-container").show() : $("ftp-credentials-container").hide();
    ...
    showPopup: function (divId) {
      ...
      this.modal = jQuery("<div></div>")
        .attr({
          id: divId,
        })
        .html(this.backupConfig[divId].content())
        .modal({
          modalClass: "magento",
