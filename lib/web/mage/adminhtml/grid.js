...
define([
  ...
  varienGrid.prototype = {
    ...
    doExport: function () {
      ...
      if ($(this.containerId + "_export")) {
        ...
        if (this.massaction && this.massaction.checkedString) {
          this._buildFormAndSubmit(exportUrl, this.massaction.formFieldNameInternal, this.massaction.checkedString);
        } else {
    ...
    bindFieldsChange: function () {
      ...
      dataElements = $(this.containerId + this.tableSufix)
        .down("tbody")
        .select("input", "select");
  ...
  varienGridMassaction.prototype = {
    ...
    massSelect: function (evt) {
      ...
      if (this.lastChecked.left !== false && this.lastChecked.top !== false && evt.button === 0 && evt.shiftKey === true) {
        ...
        if (lastCheckbox != currentCheckbox) {
          ...
          if (start !== false && finish !== false) {
            //eslint-disable-line max-depth
            this.selectCheckboxRange(Math.min(start, finish), Math.max(start, finish), currentCheckbox.checked);
          }
        }
      }
