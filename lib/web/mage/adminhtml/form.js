      ...
      for (idTo in elementsMap) {
        ...
        for (idFrom in elementsMap[idTo]) {
          ...
          if ($(idFrom)) {
            ...
            if (radioFrom) {
              radioFrom.invoke("on", "change", this.trackChange.bindAsEventListener(this, idTo, elementsMap[idTo]));
            }
          }
          ...
          inputs.each(function (item) {
            ...
            if (
              ((!item.type || item.type != "hidden") &&
                ...
                !item.getAttribute("readonly")) ||
              isChooser //eslint-disable-line
            ) {
              item.disabled = false;
