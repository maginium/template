...
define(["underscore"], function (_) {
  ...
  var schema = {
    ...
    whiteSpace: ["audio", "iframe", "noscript", "object", "pre", "script", "style", "textarea", "video"],
    selfClosing: ["colgroup", "dd", "dt", "li", "option", "p", "td", "tfoot", "th", "thead", "tr"],
  };
  ...
  _.extend(
    schema,
    (function (phrasingContent, flowContent) {
      var validElements = [],
        validChildren = [],
        compiled = {},
        globalAttrs,
      ...
      rawData = [
        ...
        [
          ...
          "onafterprint onbeforeprint onbeforeunload onblur onerror onfocus " +
            ...
            "onpopstate onresize onscroll onstorage onunload background bgcolor text link vlink alink",
          flowContent,
        ],
        ...
        [
          "iframe",
          "src name width height longdesc frameborder marginwidth marginheight scrolling align sandbox seamless allowfullscreen",
          flowContent,
        ],
        ["embed", "src type width height"],
        [
          "object",
          "data type typemustmatch name usemap form width height declare classid code codebase codetype archive standby align border hspace vspace",
          flowContent.concat(["param"]),
        ],
        ...
        [
          ...
          flowContent.concat(["track", "source"]),
        ],
