...
define(["wysiwygAdapter", "mage/adminhtml/events", "mage/adminhtml/wysiwyg/widget"], function (wysiwyg, varienGlobalEvents) {
    ...
    var self = null,
      magentowidget = function (editor) {
        ...
        editor.addCommand("mceMagentowidget", function (img) {
          ...
          widgetTools.openDialog(config["window_url"] + "widget_target_id/" + editor.getElement().id + "/");
        });
