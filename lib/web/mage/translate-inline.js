...
define(["jquery", "mage/template", "mage/utils/misc", "mage/translate", "jquery-ui-modules/dialog"], function ($, mageTemplate, miscUtils) {
  "use strict";
    ...
    options: {
      translateForm: {
        ...
        data: {
          ...
          message: "Please refresh the page to see your changes after submitting this form. " + "Note: browser cache refresh may be required",
        },
      },
      autoOpen: false,
      translateArea: null,
      ...
      open: function () {
        ...
        $uiDialog.addClass("ui-dialog-active").css("margin-top", topMargin);
      },
