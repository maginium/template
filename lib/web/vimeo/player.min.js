...
!(function (e, t) {
  ...
  (Player = "undefined" != typeof self ? self : "undefined" != typeof window ? window : a).WeakMap ||
  ...
  function E(i, e, t) {
    ...
    return new Promise(function (t, n) {
      ...
      var e,
        r = "https://vimeo.com/api/oembed.json?url=".concat(encodeURIComponent(i));
  ...
  function M(n, r) {
    ...
    (r = P(r)).event
      ? ("error" === r.event &&
        ...
        (t = r.data))
      : r.method && ((e = n), (o = r.method), (i = !((i = y(e, o)).length < 1) && ((i = i.shift()), g(e, o, i), i)) && (a.push(i), (t = r.value))),
  ...
  var N,
    ...
    Player = (function () {
      function Player(i) {
        ...
        if (("IFRAME" === i.nodeName || ((r = i.querySelector("iframe")) && (i = r)), "IFRAME" === i.nodeName && !l(i.getAttribute("src") || "")))
                ...
                E(u((e = b(i, t))), e, i)
                  .then(function (e) {
                    var t,
                      ...
                      r = k(e, i);
                    return (
                      (a.element = r), (a._originalElement = i), (t = i), (n = r), (r = v.get(t)), v.set(n, r), v.delete(t), C.set(a.element, a), e
                    );
                  })
                  .catch(o);
          });
      ...
      return (
        ...
        (t = [
          ...
          },
          {
            key: "addCuePoint",
            value: function (e) {
              return this.callMethod("addCuePoint", { time: e, data: 1 < arguments.length && void 0 !== arguments[1] ? arguments[1] : {} });
            },
          },
          {
            key: "removeCuePoint",
          ...
          },
          {
            ...
            value: function () {
              ...
              return new m(function (e) {
                ...
                j.delete(n),
                  C.delete(n.element),
                  n._originalElement && (C.delete(n._originalElement), n._originalElement.removeAttribute("data-vimeo-initialized")),
                  n.element &&
                  ...
                  n.element &&
                    ...
                    (t = n.element.querySelector("iframe")) &&
                      t.parentNode &&
                      (t.parentNode.parentNode && n._originalElement && n._originalElement !== t.parentNode
                        ? t.parentNode.parentNode.removeChild(t.parentNode)
                        : t.parentNode.removeChild(t))),
                  n._window.removeEventListener("message", n._onMessage),
                  A.isEnabled && A.off("fullscreenchange", n.fullscreenchangeHandler),
                  e();
              });
            },
          },
  ...
  return (
    e ||
      ...
      (F = { fullscreenchange: N.fullscreenchange, fullscreenerror: N.fullscreenerror }),
      (x = {
        request: function (o) {
          ...
          return new Promise(function (t, e) {
            ...
            x.isFullscreen
              ? ((n = function e() {
                ...
                x.on("fullscreenchange", n),
                (r = document[N.exitFullscreen]()) instanceof Promise && r.then(n).catch(e))
              : t();
          });
        },
        on: function (e, t) {
