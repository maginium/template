...
!(function () {
  ...
  const $ = (e) => void 0 !== e.style && a(e.style.getPropertyValue),
    ...
    F = (e) => {
      ...
      return ((e) => {
        ...
        var o;
      })(P.fromDom(t)).fold(() => o.body.contains(t), ((n = F), (r = q), (e) => n(r(e))));
      var n, r;
    },
  ...
  const ee = (e, t) => ({ element: e, offset: t }),
    ...
    se = {
      up: d({
        selector: Q,
        closest: (e, t, o) => ((e, t, o, n, r) => (((e, t) => O(e, t))(o, n) ? u.some(o) : a(r) && r(o) ? u.none() : t(o, n, r)))(0, Q, e, t, o),
        predicate: G,
        all: (e, t) => {
          const o = a(t) ? t : m;
          let n = e.dom;
      ...
      styles: d({
        ...
        remove: (e, t) => {
          ((e, t) => {
            ...
            ((e, t, o = c) => e.exists((e) => o(e, t)))(D(e, "style").map(R), "") && E(e, "style");
        },
      }),
      attrs: d({
        get: x,
      ...
      create: d({ nu: P.fromTag, clone: (e) => P.fromDom(e.dom.cloneNode(!1)), text: P.fromText }),
      query: d({
  ...
  const Se = (e) => {
    ...
    Me = (e) => {
      ...
      for (let e = 0; e < t.length; e++) {
        const a = t[e];
        "summary" === a.name && s(o) ? (o = a) : (i = a).name === ce && p(Se(i), de) && s(n) ? (n = a) : r.push(a);
      }
      var i;
  ...
  e.add("accordion", (e) => {
    ((e) => {
      ...
      e.ui.registry.addButton("accordion", { icon: "accordion", tooltip: "Insert accordion", onSetup: Re(e), onAction: t }),
        e.ui.registry.addMenuItem("accordion", { icon: "accordion", text: "Accordion", onSetup: Re(e), onAction: t }),
          ...
          o.addNodeFilter(ie, (e) => {
            for (let t = 0; t < e.length; t++) {
              ...
              if (Ee(o)) {
                ...
                s(l.firstChild) && Pe(l), xe(l, [le]), a || (i(e.firstChild) ? e.insert(l, e.firstChild, !0) : e.append(l));
                const d = i(n),
                  c = d ? n : new Ce(ce, 1);
