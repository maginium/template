      ...
      ((e) => {
        ...
        return null === e
          ...
          : "object" === t && Array.isArray(e)
            ? "array"
            : "object" === t &&
                ((r = o = e), (a = String).prototype.isPrototypeOf(r) || (null === (s = o.constructor) || void 0 === s ? void 0 : s.name) === a.name)
              ? "string"
              : t;
        var r, o, a, s;
      })(t) === e,
    ...
    re = (e) => {
      const t = ((e) => {
        ...
        s = {
          title: "General",
          name: "general",
          items: c([[{ name: "source", type: "urlinput", filetype: "media", label: "Source", picker_text: "Browse files" }], a]),
        },
        i = [];
          ...
          l("webkitallowfullscreen mozallowfullscreen".split(" "), (e) => {
            ...
            o.addNodeFilter(
              ...
              ((e) => (t) => {
                ...
                for (; o--; )
                  (r = t[o]),
                    r.parent && (r.parent.attr("data-mce-object") || (ae(r) && v(e) ? ue(r) || r.replace(le(e, r)) : ue(r) || r.replace(ne(e, r))));
              })(e),
            ),
        ...
        e.on("mousedown", (t) => {
          ...
          e.on("ObjectResized", (t) => {
            ...
            if (r.getAttribute("data-mce-object")) {
              ...
              o &&
                ((o = unescape(o)),
                r.setAttribute("data-mce-html", escape(U(o, { width: String(t.width), height: String(t.height) }, !1, e.schema))));
            }
          });
      })(e),
      ((e) => ({
