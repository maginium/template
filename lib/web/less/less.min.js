...
!(function (e, t) {
              ...
              return (
                (S(t.props) && !t.props.includes(n)) ||
                  (function (e, t, i, n, r) {
                    ...
                    "enumerable" === s && (e[t] = i),
                      r && "nonenumerable" === s && Object.defineProperty(e, t, { value: i, enumerable: !1, writable: !0, configurable: !0 });
  ...
  var N = (function () {
      ...
      return (
        (e.prototype.visit = function (e) {
          ...
          if (
            ((o.visitDeeper = !0),
            r || ((r = n[(i = "visit" + e.type)] || j), (s = n[i + "Out"] || j), (this._visitInCache[t] = r), (this._visitOutCache[t] = s)),
            r !== j)
          ) {
            var a = r.call(n, e, o);
            e && n.isReplacing && (e = a);
        ...
        (e.prototype.findMatch = function (e, t) {
          ...
          for (i = 0; i < t.length; i++)
            for (n = t[i], r = 0; r < n.elements.length; r++)
              for (
                s = n.elements[r],
                  (e.allowBefore || (0 === i && 0 === r)) && c.push({ pathIndex: i, index: r, matched: 0, initialCombinator: s.combinator }),
                  a = 0;
                a < c.length;
                a++
              )
                (l = c[a]),
                  ...
                  !this.isElementValuesEqual(u[l.matched].value, s.value) || (l.matched > 0 && u[l.matched].combinator.value !== o)
                    ? (l = null)
                    : l.matched++,
                  l &&
                  ...
                  l
                    ? l.finished && ((l.length = u.length), (l.endPathIndex = i), (l.endPathElementIndex = r + 1), (c.length = 0), h.push(l))
                    : (c.splice(a, 1), a--);
          return h;
        }),
        (e.prototype.isElementValuesEqual = function (e, t) {
          ...
          if (e instanceof He.Attribute)
            return (
              e.op === t.op &&
              e.key === t.key &&
              (e.value && t.value ? (e = e.value.value || e.value) === (t = t.value.value || t.value) : !e.value && !t.value)
            );
          if (((e = e.value), (t = t.value), e instanceof He.Selector)) {
            ...
            for (var i = 0; i < e.elements.length; i++) {
              if (
                ...
                (0 !== i || (e.elements[i].combinator.value || " ") !== (t.elements[i].combinator.value || " "))
              )
                return !1;
          ...
          for (r = 0; r < e.length; r++)
            (s = t[(a = e[r]).pathIndex]),
              ...
              u === a.pathIndex && r > 0
                ...
                : (h = h.concat(t.slice(u, a.pathIndex))).push(new He.Selector(l)),
              (u = a.endPathIndex),
  ...
  X.prototype = {
    ...
    visitAtRuleWithBody: function (e, t) {
      ...
      return (
        e.accept(this._visitor), (t.visitDeeper = !1), this.utils.isEmpty(e) || this._mergeRules(e.rules[0].rules), this.utils.resolveVisibility(e, i)
      );
    },
  ...
  var ee = function () {
    ...
    return (
      ...
      (l.end = function () {
        ...
        return (
          l.i < i && ((t = n), (l.i = i)),
          { isFinished: r, furthest: l.i, furthestPossibleErrorMessage: t, furthestReachedEnd: l.i >= e.length - 1, furthestChar: e[l.i] }
        );
      }),
      l
    );
    ...
    re = function e(t, i, n, r) {
      ...
      return {
        ...
        parse: function (r, l, u) {
          ...
          (h || (u && u.banner)) &&
            ((d = (u && u.banner ? u.banner : "") + h), ((p = i.contentsIgnoredChars)[n.filename] = p[n.filename] || 0), (p[n.filename] += d.length)),
            (r = d + (r = r.replace(/\r\n?/g, "\n")).replace(/^\uFEFF/, "") + f),
        ...
        parsers: (s = {
          ...
          variableCall: function (e) {
            ...
            if ((o.save(), a || ("@" === o.currentChar() && (a = o.$re(/^(@[\w-]+)(\(\s*\))?/))))) {
              if (!(t = this.mixin.ruleLookups()) && ((r && "()" !== o.$str("()")) || "()" !== a[2]))
            ...
            call: function (e, t) {
              ...
              if ("." === h || "#" === h) {
                if ((o.save(), (a = this.elements()))) {
                  if ((o.$char("(") && ((l = this.args(!0).args), u(")"), (c = !0)), !1 !== t && (i = this.ruleLookups()), !0 === t && !i))
          ...
          ieAlpha: function () {
            ...
            if (o.$re(/^opacity=/i))
              return (
                (e = o.$re(/^\d+/)) || (e = "@{" + (e = l(s.entities.variable, "Could not parse alpha")).name.slice(1) + "}"),
                u(")"),
          ...
          selectors: function () {
            for (
              ...
              e.condition && t.length > 1 && a("Guards are only currently allowed on a single selector."),
              o.$char(","));
          ...
          permissiveValue: function (e) {
            ...
            if (!h()) {
              ...
              if ((o.save(), (s = o.$parseUntil(l)))) {
                if (("string" == typeof s && a("Expected '" + s + "'", "Parse"), 1 === s.length && " " === s[0]))
            ...
            do {
              (t = l.keyword() || l.variable() || l.mixinLookup())
                ...
                : o.$char("(") &&
                  ...
                  o.$char(")")
                    ? i && !t
                      ? (u.push(new He.Paren(new He.QueryInParens(i.op, i.lvalue, i.rvalue, s ? s.op : null, s ? s.rvalue : null, i._index))),
                        (t = i))
                      : i && t
            ...
            if ((i = t || h()))
              return (
                o.$char(">")
                  ...
                  : o.$char("<")
                    ? (l = o.$char("=") ? "<=" : "<")
                    : o.$char("=") && (l = o.$char(">") ? "=>" : o.$char("<") ? "=<" : "="),
                l
                  ? (n = h())
                    ? (s = new He.Condition(l, i, n, c + r, !1))
                    : a("expected expression")
                  : t || (s = new He.Condition("=", i, new He.Keyword("true"), c + r, !1)),
                s
              );
          },
          operand: function () {
  ...
  se.prototype = Object.assign(new u(), {
    ...
    genCSS: function (e, t) {
      var i;
      for (
        (e && e.firstSelector) || "" !== this.elements[0].combinator.value || t.add(" ", this.fileInfo(), this.getIndex()), i = 0;
      ...
      for (r = 0; (f = y[r]); r++)
        if (f instanceof me && f.selectors && 1 === f.selectors.length && f.selectors[0] && f.selectors[0].isJustParentSelector()) {
          ...
          for (a = 0; (p = f.rules[a]); a++)
            p instanceof u && (p.copyVisibilityInfo(f.visibilityInfo()), (p instanceof ce && p.variable) || y.splice(++r, 0, p));
        }
    ...
    evalImports: function (e) {
      ...
      if (n)
        for (t = 0; t < n.length; t++)
          "Import" === n[t].type &&
            ((i = n[t].eval(e)) && (i.length || 0 === i.length) ? (n.splice.apply(n, [t, 1].concat(i)), (t += i.length - 1)) : n.splice(t, 1, i),
            this.resetCache());
    },
    makeImportant: function () {
      return new me(
      ...
      function i(e) {
        return e.value instanceof le && !e.parsed
          ? ("string" == typeof e.value.value
              ? new re(this.parse.context, this.parse.importManager, e.fileInfo(), e.value.getIndex()).parseNode(
                  e.value.value,
                  ["value", "important"],
                  function (t, i) {
    ...
    joinSelector: function (e, t, i) {
      ...
      function a(e, t) {
        ...
        if (0 !== e.length)
          if (0 !== t.length)
            for (i = 0; (n = t[i]); i++)
              n.length > 0 ? (n[n.length - 1] = n[n.length - 1].createDerived(n[n.length - 1].elements.concat(e))) : n.push(new se(e));
      ...
      if (
        !(function e(t, i, l) {
          ...
          for (f = [], v = [[]], u = 0; (y = l.elements[u]); u++)
            if ("&" !== y.value) {
              ...
              for (I = !0, d = [], a(f, v), c = 0; c < v.length; c++)
                if (((g = v[c]), 0 === i.length))
                  g.length > 0 && g[0].elements.push(new m(y.combinator, "", y.isVariable, y._index, y._fileInfo)), d.push(g);
                else
          ...
          for (a(f, v), u = 0; u < v.length; u++)
            (b = v[u].length) > 0 && (t.push(v[u]), (w = v[u][b - 1]), (v[u][b - 1] = w.createDerived(w.elements, l.extendList)));
          return I;
        })((c = []), t, i)
      )
        if (t.length > 0)
  ...
  var ge = function (e, t, i, n, r, s, o, a) {
    ...
    if (((this.name = e), (this.value = t instanceof u ? t : t ? new le(t) : t), i)) {
      for (
        Array.isArray(i) ? (this.rules = i) : ((this.rules = [i]), (this.rules[0].selectors = new se([], null, null, n, r).createEmptySelectors())),
          l = 0;
        l < this.rules.length;
        l++
      )
      ...
      if ("+" === t || "-" === t)
        if (0 === r.numerator.length && 0 === r.denominator.length)
          ...
          if (((i = i.convertTo(this.unit.usedUnits())), e.strictUnits && i.unit.toString() !== r.toString()))
            throw new Error(
              "Incompatible units. Change the units or use the unit function. Bad units: '" + r.toString() + "' and '" + i.unit.toString() + "'.",
            );
  ...
  _e.prototype = Object.assign(new u(), {
    ...
    eval: function (e) {
      ...
      if (null != n)
        return n instanceof u || (n = new le(n && !0 !== n ? n.toString() : null)), (n._index = this._index), (n._fileInfo = this._fileInfo), n;
  ...
  Pe.prototype = Object.assign(new u(), {
    ...
    eval: function (e) {
      ...
      if (this.evaluating)
        throw { type: "Name", message: "Recursive property reference for " + i, filename: this.fileInfo().filename, index: this.getIndex() };
      if (
        ((this.evaluating = !0),
        (t = this.find(e.frames, function (t) {
          var r,
          ...
          if (s) {
            for (var o = 0; o < s.length; o++)
              (r = s[o]), (s[o] = new ce(r.name, r.value, r.important, r.merge, r.index, r.currentFileInfo, r.inline, r.variable));
  ...
  Me.prototype = Object.assign(new u(), {
    ...
    toCSS: function (e) {
      ...
      return (
        this.op && ((t += this.op), (t += this.value.toCSS ? this.value.toCSS(e) : this.value)), this.cif && (t = t + " " + this.cif), "[" + t + "]"
      );
    },
  });
    ...
    eval: function (e) {
      ...
      for (t = 0; t < this.lookups.length; t++) {
        if (((i = this.lookups[t]), Array.isArray(n) && (n = new me([new se()], n)), "" === i)) n = n.lastDeclaration();
          ...
          if (
            ((i = "$@" === i.substring(0, 2) ? "$" + new Ae(i.substr(1)).eval(e).value : "$" === i.charAt(0) ? i : "$" + i),
  ...
  We.prototype = Object.assign(new me(), {
    ...
    evalParams: function (e, t, i, n) {
      var r,
        ...
        v = 0;
      if (
        (t.frames && t.frames[0] && t.frames[0].functionRegistry && (f.functionRegistry = t.frames[0].functionRegistry.inherit()),
          ...
          if (((s = i && i[h]), (u = p[o].name)))
            if (p[o].variadic) {
              ...
              if ((l = s && s.value)) l = Array.isArray(l) ? new ye(new me("", l)) : l.eval(e);
                ...
                if (!p[o].value)
                  throw { type: "Runtime", message: "wrong number of arguments for " + this.name + " (" + v + " for " + this.arity + ")" };
    ...
    matchCondition: function (e, t) {
      return !(
        ...
        !this.condition.eval(
          new D.Eval(
            t,
            [this.evalParams(t, new D.Eval(t, this.frames ? this.frames.concat(t.frames) : t.frames), e, [])]
              .concat(this.frames || [])
              .concat(t.frames),
          ),
        )
            ...
            if (0 === (h = b[a].group) || h === f)
              try {
                (i = b[a].mixin) instanceof We ||
                  ((v = i.originalRuleset || i), ((i = new We("", [], i.rules, null, !1, null, v.visibilityInfo())).originalRuleset = v));
          ...
          return e
            ? ("function" == typeof e && (e = new e()),
              e.minVersion && this.compareVersion(e.minVersion, this.less.version) < 0
                ? new V({ message: "Plugin " + i + " requires version " + this.versionToString(e.minVersion) })
                : e)
            : null;
        }),
    ...
    ht = {
      ...
      each: function (e, t) {
        ...
        var a = "@value",
          ...
          c = "@index";
        t.params
          ? ((a = t.params[0] && t.params[0].name), (l = t.params[1] && t.params[1].name), (c = t.params[2] && t.params[2].name), (t = t.rules))
          : (t = t.ruleset);
        ...
        if ((r = t[i]) instanceof we)
          if (
            ((l =
              ("" !==
                (a =
                  "" === (s = "" === r.unit.toString() && void 0 !== u ? new we(r.value, u).unify() : r.unify()).unit.toString() && void 0 !== l
                    ? l
                    : s.unit.toString()) &&
                void 0 === l) ||
            ...
            (o = "" === h[n].unit.toString() && void 0 !== u ? new we(h[n].value, u).unify() : h[n].unify()),
              ((e && s.value < o.value) || (!e && s.value > o.value)) && (h[n] = r);
          else {
  ...
  function St(e, t) {
    ...
    "object" != typeof n ||
      ...
      ((n = Object.keys(n).map(function (e) {
        var t = n[e];
        return (
          t instanceof He.Value || (t instanceof He.Expression || (t = new He.Expression([t])), (t = new He.Value([t]))),
          ...
          return (
            (t.prototype.push = function (t, i, n, s, o) {
              ...
              var u = function (e, i, n) {
                  ...
                  s.optional && e
                    ? (o(null, { rules: [] }, !1, null),
                      r.info("The file " + n + " was skipped because it was not found and the import was marked optional."))
        ...
        var n = function (e, t, r) {
          ...
          if (((t.pluginManager = l), (o = new D.Parse(t)), t.rootFileInfo)) a = t.rootFileInfo;
            ...
            var u = t.filename || "input",
              c = u.replace(/[^/\\]*$/, "");
            (a = { filename: u, rewriteUrls: o.rewriteUrls, rootpath: o.rootpath || "", currentDirectory: c, entryPath: c, rootFilename: u })
              .rootpath &&
              "/" !== a.rootpath.slice(-1) &&
              (a.rootpath += "/");
          }
          ...
          (this.importManager = h),
            t.plugins &&
              t.plugins.forEach(function (e) {
                var t, i;
                if (e.fileContent) {
                  if (((i = e.fileContent.replace(/^\uFEFF/, "")), (t = l.Loader.evalPlugin(i, o, h, e.options, e.filename)) instanceof V))
                    return r(t);
                } else l.addPlugin(e);
              }),
            new re(o, h, a).parse(
          ...
          r.errorReporting && "html" !== r.errorReporting
            ? "console" === r.errorReporting
              ? (function (e, t) {
                  ...
                  e.line &&
                    (a(e, 0, ""), a(e, 1, "line"), a(e, 2, ""), (o += " on line " + e.line + ", column " + (e.column + 1) + ":\n" + s.join("\n"))),
