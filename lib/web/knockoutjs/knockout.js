    ...
    (function (factory) {
      ...
      ko.isWriteableObservable = function (instance) {
        return (
          ...
          (instance[protoProperty] === observableFn[protoProperty] || // Observable
            (instance[protoProperty] === ko.computed["fn"][protoProperty] && instance.hasWriteFunction))
      ...
      var computedFn = {
        ...
        evaluateImmediate: function (notifyChange) {
          ...
          if (
            (state.disposeWhenNodeIsRemoved && !ko.utils.domNodeIsAttachedToDocument(state.disposeWhenNodeIsRemoved)) ||
            ...
            switch (typeof propertyValue) {
              ...
              case "undefined":
                ...
                outputProperties[indexer] =
                  previouslyMappedValue !== undefined ? previouslyMappedValue : mapJsObjectGraph(propertyValue, mapInputCallback, visitedObjects);
                break;
            }
          });
      ...
      ko.expressionRewriting = (function () {
        ...
        function preProcessBindings(bindingsStringOrKeyValueArray, bindingOptions) {
          ...
          var resultStrings = [],
            ...
            keyValueArray =
              typeof bindingsStringOrKeyValueArray === "string" ? parseObjectLiteral(bindingsStringOrKeyValueArray) : bindingsStringOrKeyValueArray;
        ...
        ko.bindingContext = function (dataItemOrAccessor, parentContext, dataItemAlias, extendCallback, options) {
          ...
          function updateContext() {
            ...
            if (
              ...
              !ko.computedContext.computed().hasAncestorDependency(parentContext[contextSubscribable])
            ) {
              parentContext[contextSubscribable]();
            }
            ...
            if (bindingInfo) {
              ...
              if (event == ko.bindingEvent.childrenComplete) {
                if (bindingInfo.asyncContext) {
                  ...
                  bindingInfo.eventSubscribable.hasSubscriptionsForEvent(ko.bindingEvent.descendantsComplete)
                ) {
        ...
        update: function (element, valueAccessor, allBindings) {
          ...
          function applyToObject(object, predicate, defaultValue) {
            ...
            if (predicateType == "function")
              ...
              return object[predicate]; // Given no optionsText arg; use the data value itself
        ...
        ko.utils.setDomNodeChildrenFromArrayMapping = function (domNode, array, mapping, options, callbackAfterAddingNodes, editScript) {
          ...
          for (i = 0; (mapData = newMappingResult[i]); i++) {
            ...
            if (!mapData.mappedNodes)
              ko.utils.extend(
                mapData,
                mapNodeAndRefreshWhenChanged(domNode, mapping, mapData.arrayEntry, callbackAfterAddingNodes, mapData.indexObservable),
              );
