    ...
    return this.filter("select[multiple]:not(." + o.mselectHiddenClass + ")")
      .each(function () {
        var select = $(this).addClass(o.mselectHiddenClass).hide(),
          ...
          buttonAdd = widget.find("." + o.mselectButtonAddClass + "").on("click.mselectAdd", function (e) {
            e.preventDefault();
          ...
          buttonSave = container.find("." + o.mselectButtonSaveClass + "").on("mousedown.mselectSave", function (e) {
            append(input.val());
          }),
          buttonCancel = container.find("." + o.mselectButtonCancelClass + "").on("mousedown.mdelectCancel", function (e) {
            input.val("");
          }),
          append = function (v) {
            ...
            $.each(typeof o.parse == "function" ? o.parse(v) : [$.trim(v)], function (i, v) {
              ...
              if (v && !select.children('[value="' + v + '"]').length) {
                ...
                list.children("." + o.mselectListItemClass + "").length
                  ? list
                      .children("." + o.mselectListItemClas)
                      .last()
                      .after(item)
                  : list.prepend(item);
          ...
          reset = function () {
            ...
            if (ch.length >= size && !list.hasClass(o.mselectItemsWrapperOverflowClass)) {
              list
                .height(
                  list
                    .children("." + o.mselectListItemClass)
                    .first()
