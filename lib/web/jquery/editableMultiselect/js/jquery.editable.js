...
(function ($) {
  ...
  $.fn.editable = function (target, options) {
    ...
    if ("destroy" === target) {
      $(this).off($(this).data("event.editable")).removeData("disabled.editable").removeData("event.editable");
      return;
    }
    ...
    return this.each(function () {
      ...
      self.destroy = function (form) {
        $(self).off($(self).data("event.editable")).removeData("disabled.editable").removeData("event.editable");
