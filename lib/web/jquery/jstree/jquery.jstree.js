  ...
  $.jstree.core.prototype = {
    ...
    edit: function (obj, default_text, callback) {
      ...
      /*!
			...
			*/
      t = default_text;
      h1 = $("<" + "div></div>", { css: { position: "absolute", top: "-200px", left: rtl ? "0px" : "-1000px", visibility: "hidden" } }).appendTo(
        document.body,
      );
      h2 = $("<" + "input />", {
        value: t,
  ...
  (function ($) {
    ...
    $.vakata.context = {
      ...
      _execute: function (i) {
        ...
        return i &&
          (!i._disabled ||
            ($.vakata.is_function(i._disabled) && !i._disabled({ item: i, reference: vakata_context.reference, element: vakata_context.element }))) &&
          i.action
          ? i.action.call(null, {
              item: i,
              reference: vakata_context.reference,
