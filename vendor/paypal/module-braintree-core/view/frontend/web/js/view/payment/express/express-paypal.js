...
define([
    ...
    'domReady!'
], function ($, _, Component, url, quote, payPalButton, getCartLineItems) {
    'use strict';
    ...
    return Component.extend({
        ...
        initPayPalButtons: function () {
            ...
            // this.setSkipReview(this.skipOrderReviewStep);

            let cartLineItems = window.checkoutConfig.payment['braintree_paypal'].canSendLineItems
                ? getCartLineItems(quote.getTotals()())
                : [],
                buttonConfig = {
                    'buttonConfig': {
                        ...
                        'canSendLineItems': window.checkoutConfig.payment['braintree_paypal'].canSendLineItems,
                    },
                    'buttonIds': [
