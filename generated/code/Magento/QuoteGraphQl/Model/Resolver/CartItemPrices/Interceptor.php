...
class Interceptor extends \Magento\QuoteGraphQl\Model\Resolver\CartItemPrices implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    public function __construct(\Magento\QuoteGraphQl\Model\Cart\TotalsCollector $totalsCollector, \Magento\QuoteGraphQl\Model\GetDiscounts $getDiscounts, \Magento\Framework\Pricing\PriceCurrencyInterface $priceCurrency)
    {
        $this->___init();
        parent::__construct($totalsCollector, $getDiscounts, $priceCurrency);
    }
