...
class ModuleEnableDisableCommandTest extends TestCase
{
     ...
     * @test
     */
    public function execute($isEnable, $clearStaticContent, $expectedMessage)
    {
     ...
     * @test
     */
    public function executeEnableInvalidModule()
    {
        $this->statusMock->expects($this->once())
            ->method('getModulesToChange')
            ->with(true, ['invalid'])
     ...
     * @test
     */
    public function executeDisableInvalidModule()
    {
        $this->statusMock->expects($this->once())
            ->method('getModulesToChange')
            ->with(false, ['invalid'])
     ...
     * @test
     */
    public function executeAll($isEnable, $expectedMessage)
    {
     ...
     * @test
     */
    public function executeWithConstraints($isEnable)
    {
        $this->statusMock->expects($this->once())
            ->method('getModulesToChange')
            ->with($isEnable, ['Magento_Module1', 'Magento_Module2'])
     ...
     * @test
     */
    public function executeForce($isEnable, $expectedMessage)
    {
        $this->statusMock->expects($this->once())
            ->method('getModulesToChange')
            ->with($isEnable, ['Magento_Module1', 'Magento_Module2'])
     ...
     * @test
     */
    public function executeNoChanges($isEnable)
    {
        $this->statusMock->expects($this->once())
            ->method('getModulesToChange')
            ->with($isEnable, ['Magento_Module1', 'Magento_Module2'])
