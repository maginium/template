...
class ModuleUninstallCommandTest extends TestCase
{
     ...
     * @test
     */
    public function executeFailedValidation(
     ...
     * @test
     */
    public function executeFailedDependencies(
        array $dependencies,
        array $input,
        array $expect,
    ) {
     ...
     * @test
     */
    public function executeClearStaticContent()
    {
     ...
     * @test
     */
    public function executeRemoveData()
    {
     ...
     * @test
     */
    public function executeNonComposerModules()
    {
     ...
     * @test
     */
    public function executeCodeBackup()
    {
     ...
     * @test
     */
    public function executeMediaBackup()
    {
     ...
     * @test
     */
    public function executeDBBackup()
    {
