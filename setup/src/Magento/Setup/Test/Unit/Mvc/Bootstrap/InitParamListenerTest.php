...
class InitParamListenerTest extends TestCase
{
        ...
        $serviceManager->expects($this->exactly(2))->method('setService')
            ->willReturnCallback(
                function($arg1, $arg2) {
                    ...
                    if ($arg1 === Filesystem::class && $arg2 instanceof Filesystem) {
                        return;
                    }
                },
            );
     ...
     * @test
     */
    public function createDirectoryListException()
    {
     ...
     * @test
     */
    public function createService($zfAppConfig, $env, $argv, $expectedArray)
    {
