...
class Cache implements ConfigOptionsListInterface
{
    ...
    public const CONFIG_VALUE_CACHE_REDIS = Redis::class;
    ...
    public function validate(array $options, DeploymentConfig $deploymentConfig)
    {
        ...
        $currentCacheBackend = $deploymentConfig->get(self::CONFIG_PATH_CACHE_BACKEND);
    ...
    private function validateRedisConfig(array $options, DeploymentConfig $deploymentConfig)
    {
        ...
        $config['_useLua'] = $options[self::INPUT_KEY_CACHE_BACKEND_REDIS_LUA_KEY]
            ?? $deploymentConfig->get(
                self::CONFIG_PATH_CACHE_BACKEND_LUA_KEY,
                $this->getDefaultConfigValue(self::CONFIG_PATH_CACHE_BACKEND_LUA_KEY),
            );

        $config['use_lua'] = $options[self::INPUT_KEY_CACHE_BACKEND_REDIS_USE_LUA]
            ?? $deploymentConfig->get(
                self::CONFIG_PATH_CACHE_BACKEND_USE_LUA,
